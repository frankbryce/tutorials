...
begin
  calc (a + b) + a = a + b + a : by ring
  ... = a + a + b              : by ring
  ... = 2*a + b                : by { rw two_mul a},
end
...
begin
  ...
  ... = a*a + b*a - b*a - b*b          : by { rw mul_comm a b }
  ... = a*a + (b*a - b*a) - b*b        : by { rw add_sub }
  ... = a*a + 0 - b*b                  : by { rw sub_self (b*a) }
